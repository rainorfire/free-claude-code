...
export async function showSetupScreens(
  ...
  // Login-restriction removed: ANTHROPIC_API_KEY env vars are treated as
  // authorized in all modes (see getAnthropicApiKeyWithSource in auth.ts), so
  // the interactive ApproveApiKey confirmation dialog is intentionally skipped.
